...
public class JuniHtmlReporter {
	...
	public static void setup() throws IOException {
		String junitReportFile = "C:\\Users\\HD149PQ\\eclipse-workspace\\selenium\\junitFramework\\juniReportFile.html";
		...
		junitWriter.write("<h1> Text Execution Summary " + df.format(date) + "</h1>");
	...
	public TestRule watchman = new TestWatcher() {
		...
		@override // will overrirde the superclass
